...
class EmailVerificationCodeServiceIntegrationTest extends BaseIntegrationTest {
    ...
    class GenerateAndSaveCodeTest {
        ...
        void generateAndSaveCode_returns6DigitCode() {
            // when
            String code = emailVerificationCodeService.generateAndSaveCode(TEST_EMAIL);
        ...
        void generateAndSaveCode_setsTtl() {
            // when
            emailVerificationCodeService.generateAndSaveCode(TEST_EMAIL);
        ...
        void generateAndSaveCode_resetsAttempts() {
            // given
            emailVerificationCodeService.generateAndSaveCode(TEST_EMAIL);
            emailVerificationCodeService.verifyCode(TEST_EMAIL, "000000");
            emailVerificationCodeService.verifyCode(TEST_EMAIL, "000000");
    ...
    class VerifyCodeTest {
        ...
        void verifyCode_correctCode_returnsTrue() {
            ...
            // when
            boolean result = emailVerificationCodeService.verifyCode(TEST_EMAIL, code);
        ...
        void verifyCode_wrongCode_returnsFalse() {
            ...
            // when
            boolean result = emailVerificationCodeService.verifyCode(TEST_EMAIL, "000000");
        ...
        void verifyCode_success_deletesCode() {
            ...
            // when
            emailVerificationCodeService.verifyCode(TEST_EMAIL, code);
        ...
        void verifyCode_nonExistentCode_returnsFalse() {
            // when
            boolean result = emailVerificationCodeService.verifyCode(TEST_EMAIL, "123456");
    ...
    class HasExceededAttemptsTest {
        ...
        void hasExceededAttempts_noAttempts_returnsFalse() {
            // when
            boolean result = emailVerificationCodeService.hasExceededAttempts(TEST_EMAIL);
    ...
    class DeleteCodeTest {
        ...
        void deleteCode_deletesCodeAndAttempts() {
            ...
            // when
            emailVerificationCodeService.deleteCode(TEST_EMAIL);
